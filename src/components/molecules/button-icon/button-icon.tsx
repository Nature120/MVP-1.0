...
export const ButtonIcon: React.FC<IButtonIconProps> = props => {
  const { onPress, isWithBg, size, iconIndent = 0, ...iconProps } = props;
  return (
    <Styled.ButtonIcon isWithBg={isWithBg} onPress={onPress} size={size} hitSlop={hitSlop} activeOpacity={0.8}>
